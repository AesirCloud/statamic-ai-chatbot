...
return [
    ...
    'widget' => [
        ...
        'button_text_color' => env('STATAMIC_AI_CHATBOT_BUTTON_TEXT_COLOR', '#14362f'),
        'surface_color' => env('STATAMIC_AI_CHATBOT_SURFACE_COLOR', '#f1f4f5'),
        'surface_text_color' => env('STATAMIC_AI_CHATBOT_SURFACE_TEXT_COLOR', '#5b6670'),
        'border_color' => env('STATAMIC_AI_CHATBOT_BORDER_COLOR', '#d9e0e3'),
