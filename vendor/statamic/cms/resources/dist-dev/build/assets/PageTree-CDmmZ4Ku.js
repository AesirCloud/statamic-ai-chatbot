import { _ as _export_sfc, I as Icon, D as DropdownMenu, e as Dropdown, l as link_default, r as resolveComponent, f as resolveDirective, o as openBlock, a as createElementBlock, g as renderSlot, h as createCommentVNode, d as createBaseVNode, w as withDirectives, i as createVNode, c as createBlock, t as toDisplayString, n as normalizeClass, j as withModifiers, k as withCtx, P as Panel, m as PanelHeader, A as Ae, v as vShow, p as normalizeProps, q as guardReactiveProps, s as walkTreeData, u as router, x as lt, y as clone } from "./index-DwP14X7s.js";
const _sfc_main$1 = {
  ...
  methods: {
    ...
    afterDrop() {
      ...
      if (this.expectsRoot && root.id !== this.pages[0].id && root.children?.length > 0) {
        const { dragNode, parent, indexBeforeDrop } = lt.startInfo;
      ...
      default: withCtx(() => [
        ...
        !$data.loading ? (openBlock(), createElementBlock("div", {
          ...
          createVNode(_component_Draggable, {
            ...
            _: 3
          }, 8, ["modelValue", "disable-drag", "dir", "node-key", "each-droppable", "max-level", "stat-handler", "onAfterDrop", "onOpen:node", "onClose:node"])
