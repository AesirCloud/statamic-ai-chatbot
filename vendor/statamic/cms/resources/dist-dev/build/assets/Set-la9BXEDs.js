import { $ as defineComponent, a3 as h$1, a0 as ref, av as watchEffect, aw as nextTick, ax as unref, a2 as onBeforeUnmount, ay as getCurrentInstance, V as markRaw, az as toRaw, aA as reactive, aB as render, aC as shallowRef, a1 as onMounted, aD as customRef, aE as provide, _ as _export_sfc, ae as containerContextKey, aF as ManagesPreviewText, aG as HasFieldActions, I as Icon, aH as Badge, aI as Subheading, aJ as Switch, aK as FieldsProvider, aL as Fields, aM as DropdownSeparator, aN as DropdownItem, D as DropdownMenu, e as Dropdown, H as Button, r as resolveComponent, f as resolveDirective, o as openBlock, c as createBlock, k as withCtx, d as createBaseVNode, j as withModifiers, n as normalizeClass, a as createElementBlock, i as createVNode, h as createCommentVNode, N as createTextVNode, t as toDisplayString, w as withDirectives, v as vShow, J as Fragment$1, K as renderList, aO as watch, aP as reveal } from "./index-DwP14X7s.js";
  ...
  return openBlock(), createBlock(_component_node_view_wrapper, { class: "my-4" }, {
    default: withCtx(() => [
      createBaseVNode("div", {
        ...
        onCut: _cache[5] || (_cache[5] = withModifiers(() => {
        }, ["stop"]))
      }, [
        ...
        $options.index !== void 0 ? withDirectives((openBlock(), createElementBlock("div", {
          key: 0,
          class: normalizeClass({ "contain-paint": $options.collapsed, "isolate": !$options.collapsed })
        }, [
